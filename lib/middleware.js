...
exports.index = function(dirPath, whitelist){
  return function(req, rsp, next){
    ...
    if(arr.length == 2){
      fs.readdir(dirPath, function(err, files){
        ...
        var whitelistFiles = files.filter(function(file) {
          return whitelist.indexOf(file) > -1;
        });

        whitelistFiles.forEach(function(file){
...
exports.hostProjectFinder = function(dirPath, whitelist){
  return function(req, rsp, next){
    var host        = req.headers.host;
    var hostname    = host.split(':')[0];
    var matches     = [];
